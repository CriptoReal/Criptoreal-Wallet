...
(function () {
	...
	coinjs.pub = 0x1c;
	coinjs.priv = 0x50;
	coinjs.multisig = 0x3F;
	coinjs.hdkey = {'prv':0x0488ade4, 'pub':0x0488b21e};

	coinjs.compressed = false;

	/* other vars */
	coinjs.developer = 'CRiPToRGkyakNUq7nTYTNYpGoEj4f5frzd'; // CriptoReal
	...
	*/
	...
	coinjs.hd = function(data){
		...
		r.master = function(pass) {
			...
			var I = hasher.getHMAC("Criptoreal seed", "TEXT", "SHA-512", "HEX");
